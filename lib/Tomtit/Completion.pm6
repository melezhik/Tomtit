...
sub options-list {
  ...
  my $list =  "--verbose --quiet -q --color --completion --clean --help --init --list --profile --remove --doc --cat --lines --last --edit --env-cat --env-set --env-edit --env-list";
...
sub profile-list ($type = 1) {
  ...
  my @list = ( 'ado', 'azure', 'git', 'hello', 'perl', 'perl6', 'ruby', 'yaml' );
